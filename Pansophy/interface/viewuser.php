...
echo '<center><a href="./viewuserpf.php?id='.$ID.'&viewallissues='.$viewAllIssues.'&viewallcontacts='.$viewAllContacts.'" target="_blank">[Click here for printer-friendly version]</a></center><br>';
echo '<table width="100%" ><tr><td valign="top" width="45%">';
   ...
   echo '<tr><td>';
      ...
      echo '<p><p><table cellspacing="3"><tr><td nowrap><p class="largeheading">Issue History</p></td>';
         if($viewAllIssues) echo '<td nowrap><a href="./viewuser.php?id='.$ID.'&viewallissues=0&viewallcontacts='.$viewAllContacts.'"><b>[Reduce]</b></a>';
         else echo '<td nowrap><a href="./viewuser.php?id='.$ID.'&viewallissues=1&viewallcontacts='.$viewAllContacts.'"><b>[View All]</b></a>';
         echo '</td></tr>';
      echo '</table>';
   ...
   echo '<td rowspan="2" valign="top">';
      ...
      // contacts section
		echo '<p><p><table cellspacing="3"><tr><td nowrap><p class="largeheading">Contact History</p></td>';
         if($viewAllContacts) echo '<td nowrap><a href="./viewuser.php?id='.$ID.'&viewallcontacts=0&viewallissues='.$viewAllIssues.'"><b>[Reduce]</b></a>';
         else echo '<td nowrap><a href="./viewuser.php?id='.$ID.'&viewallcontacts=1&viewallissues='.$viewAllIssues.'"><b>[View All]</b></a>';
         echo '</td></tr>';
      echo '</table>';
