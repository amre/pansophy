...
if(strcmp($_POST['submit'], 'Yes') == 0){
	...
	echo "<br>$FirstName $LastName has created issues and/or contacts that are still in the system. <br>You can either delete the associated issues and contacts and then delete the user, <br>or you can just set his/her access level to \"No Access\" using the \"Edit this user\" link.";
}
else{
